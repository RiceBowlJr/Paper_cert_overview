...
There is a big problem with CPS (Certification Practice Statements), that can be seen such as flexibility (for pros), because each CA answer specific needs, so that is a sort of lack of harmonization.

Also, regarding to the law, CAs deny all leak of information from themselves \cite{gerck1998overview}.
...
The dark points of this systems are:
\begin{itemize}
